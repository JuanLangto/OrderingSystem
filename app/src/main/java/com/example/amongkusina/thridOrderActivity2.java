...
public class thridOrderActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thrid_order2);
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(thridOrderActivity2.this, "Order added", Toast.LENGTH_SHORT).show();
            }
        });
